...
<div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="container">
        <a href="fuels" class="navbar-brand"><img src="resources/images/icon.png"></a>
        <div class="content"><a href="fuels" class="navbar-brand"><spring:message code="app.title"/></a></div>
                ...
                <li>
                    <sec:authorize access="isAuthenticated()">
                        <form:form class="navbar-form" action="logout" method="post">
                            ...
                            <a class="btn btn-info" href="order"><spring:message code="common.order"/></a>
